...
curl_updates = "curl -s -X GET \"https://api.telegram.org/bot{}/getUpdates"  # "?offset=1000000000000\""
...
class OsCmd:
    def __init__(self, cmd: str, *args):
        try:
            ...
            sys.stderr.write(f"!! An error occurred while starting a subprocess: {e}\n")
            exit(0)
